...
//!
//! In dev mode, watches ~/.igrok/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.igrok/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.igrok/pager.toml, watches for changes
