...
**File:** /root/.igrok/memory/MEMORY.md (lines 0-10)
```
## Project Conventions
...
"#;
        ...
        assert_eq!(results[0].path, "/root/.igrok/memory/MEMORY.md");
...
**File:** /root/.igrok/memory/ws/MEMORY.md (lines 1-5)
```
workspace content
```

### Result 2 (score: 0.42, source: session)
**File:** /root/.igrok/memory/ws/sessions/2026-05-01.md (lines 10-20)
```
session content
```
"#;
