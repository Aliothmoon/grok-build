...
//! order as a fat local `~/.igrok/sessions`). Override with env:
//!
//! ```text
...
//! CHILD_REPLAY_LOOKUP_HOME=$HOME/.igrok cargo bench -p xai-grok-shell --bench child_replay_lookup
//! ```
...
use xai_grok_config::encode_cwd_dirname;
