...
//! file logger that writes to `~/.igrok/logs/memory.log`.
//!
//! ## When to use
//!
...
//! tail -f ~/.igrok/logs/memory.log      # watch in another terminal
//! ```
...
mod inner {
    ...
    ///
    /// Writes to `~/.igrok/logs/memory.log`. Filters to `xai_memory=trace`.
