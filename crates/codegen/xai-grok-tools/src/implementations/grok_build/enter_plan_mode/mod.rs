...
mod tests {
    ...
    async fn no_absolute_path_does_not_write() {
        ...
        assert_eq!(plan_file_path, ".igrok/plan.md");
    ...
    async fn uses_plan_file_path_resource_when_set() {
        let mut resources = Resources::new();
        let session_plan = PathBuf::from("/home/user/.igrok/sessions/abc123/plan.md");
        ...
        assert!(!plan_file_path.contains(".igrok/plan.md"));
    }
    ...
    async fn falls_back_to_cwd_when_no_plan_file_path_resource() {
        ...
        assert_eq!(plan_file_path, "/workspace/my-project/.igrok/plan.md");
    }
    ...
    async fn plan_file_path_prefers_resource_over_cwd() {
        ...
        resources.insert(PlanFilePath(PathBuf::from(
            "/home/user/.igrok/sessions/xyz/plan.md",
        )));
        let shared = resources.into_shared();
        ...
        assert_eq!(plan_file_path, "/home/user/.igrok/sessions/xyz/plan.md");
        assert!(!plan_file_path.contains(".igrok/plan.md"));
    }
}
